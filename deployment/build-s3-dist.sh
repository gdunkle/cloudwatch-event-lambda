...
ZIP_FILE_NAME="cloudwatch_event_lambda-$timestamp.zip"
LAYER_FILE_NAME="cloudwatch_event_lambda-layer-$timestamp.zip"
cd ..
...
echo "------------------------------------------------------------------------------"
echo "[Build] cloudwatch_event_lambda Function"
echo "------------------------------------------------------------------------------"
cd $source_dir

zip -r $build_dist_dir/$ZIP_FILE_NAME ./cloudwatch_event_lambda/*


echo "------------------------------------------------------------------------------"
echo "[Build] cloudwatch_event_lambda Layer"
echo "------------------------------------------------------------------------------"

DEPENDENCY_EXCLUDE_LIST=${OVERRIDE_DEFAULT_DEPENDENCY_EXCLUDE_LIST:=["aws_cdk","cloudwatch_event_lambda","boto3","dist-info","pip","botocore","jsii","docutils","pkg_resources","setuptools","test","tests","s3transfer"]}
